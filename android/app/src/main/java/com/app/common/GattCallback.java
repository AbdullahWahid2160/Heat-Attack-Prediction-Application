...
import com.app.info.InfoReceiver;
import com.app.metric.hr.HeartBeatMeasurer;
...
import static com.app.common.UUIDs.AUTH_CHAR_KEY;
import static com.app.common.UUIDs.CHAR_AUTH;
import static com.app.common.UUIDs.CHAR_BATTERY;
import static com.app.common.UUIDs.CHAR_HEART_RATE_CONTROL;
import static com.app.common.UUIDs.CHAR_HEART_RATE_MEASURE;
import static com.app.common.UUIDs.CHAR_SENSOR;
import static com.app.common.UUIDs.CHAR_STEPS;
import static com.app.common.UUIDs.NOTIFICATION_DESC;
import static com.app.common.UUIDs.SERVICE1;
import static com.app.common.UUIDs.SERVICE2;
import static com.app.common.UUIDs.SERVICE_HEART_RATE;
        ...
        switch (descriptor.getCharacteristic().getUuid().toString()){
            ...
            case CHAR_HEART_RATE_MEASURE:{
                switch (Arrays.toString(descriptor.getValue())){
                    case "[1, 0]":{
                        hrCtrlChar.setValue(new byte[]{0x18, 0x01, 0x01});
