...
import { View, Text, StyleSheet, ScrollView, TextInput, TouchableOpacity, Modal, ActivityIndicator, AsyncStorage } from 'react-native';
...
export default class SignUpPage extends Component {
	...
	componentDidMount() {
		console.log("this is fucking Patient's Login")
	}
	...
	SetRole = async () => {
		try {
			this.state.role = await AsyncStorage.setItem('UserRole', "Patient")
		} catch (e) {
